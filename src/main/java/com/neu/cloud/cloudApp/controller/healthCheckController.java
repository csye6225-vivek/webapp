...
public class healthCheckController {
    ...
    public ResponseEntity<Void> healthCheck(HttpServletRequest request) {
        ...
        logger.info("This is a NEW TEST healthz structured log message to check INFO");
        logger.error("This is a NEW TEST healthz structured log message to check ERROR");
        logger.debug("This is a NEW TEST healthz structured log message to check DEBUG");
